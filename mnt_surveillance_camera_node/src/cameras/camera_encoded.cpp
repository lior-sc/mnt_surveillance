    ...
    : nh_(nh)
{
  ...
  // create publishers
  img_pub_ = nh_->create_publisher<sensor_msgs::msg::Image>(topic_name+"/img_capture_test", qos_);
  encoded_data_pub_ = nh_->create_publisher<std_msgs::msg::UInt8MultiArray>(topic_name, qos_);
